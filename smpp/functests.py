...
class MessagingTestCase(unittest.TestCase):
    ...
    def test_store_and_forward(self):
        ...
        self.assertEqual(int(r1rec.source_addr_ton), 12)
        self.assertEqual(int(r1rec.source_addr_npi), 34)
        self.assertEqual(r1rec.source_addr, b"src")
        self.assertEqual(int(r1rec.dest_addr_ton), 56)
        self.assertEqual(int(r1rec.dest_addr_npi), 67)
        self.assertEqual(r1rec.destination_addr, b"dst")
        self.assertEqual(r1rec.short_message, b"Hello world!")

        r2rec = r2.read_pdu()
        self.assertEqual(r1rec.command, 'deliver_sm')
        self.assertEqual(int(r2rec.source_addr_ton), 12)
        self.assertEqual(int(r2rec.source_addr_npi), 34)
        self.assertEqual(r2rec.source_addr, b"src")
        self.assertEqual(int(r2rec.dest_addr_ton), 56)
        self.assertEqual(int(r2rec.dest_addr_npi), 67)
        self.assertEqual(r2rec.destination_addr, b"dst")
        self.assertEqual(r2rec.short_message, b"Hello world!")
